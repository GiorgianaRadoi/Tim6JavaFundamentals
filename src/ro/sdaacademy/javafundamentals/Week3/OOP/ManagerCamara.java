...
/**manager de camara are treaba doar cu camara
 * trebuie creata camara: private static Camara camara = new Camara (2);
 *
 *
 */
...
public class ManagerCamara {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            opt = in.nextLine();
            switch (opt) {
                case "1": // alegem optiunile din camara
                    afisareCamara();
                    break;
                default:
    ...
    private static void afisareCamara(){
        //cream legatura intre camara-stelaj-raft-obiecte ( si la fiecare entitate ciclam pe ob ptr a le afisa
